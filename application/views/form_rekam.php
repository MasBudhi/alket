    ...
    <div class="row">
        <div class="login-panel panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><b>TAMBAH DATA</b></h3>
            </div>
            <div class="panel-body">
            <!--=========== The Form      ============== -->

<form class="form-horizontal" role="form" action="<?php echo base_url();?>index.php/home/simpan" method="post"> 
<input name="id" type="hidden" value="<?php echo $idnya;?>"/>
    <div class="col-sm-6 col-lg-6">   
        <div class="form-group">
            <label for="no_sp" class="col-sm-3 control-label">No. SP</label>
            <div class="col-sm-8">
                <input type="text" name="no_sp" class="form-control input-sm" placeholder="No. SP">
            </div>
        </div>
        <div class="form-group">
            <label for="tgl_sp" class="col-sm-3 control-label">Tgl SP</label>
            <div class="col-sm-8">
                <input type="text" name="tgl_sp" class="form-control datepicker input-sm" placeholder="Tgl SP">
            </div>
        </div>
        <div class="form-group">
            <label for="kpp_asal" class="col-sm-3 control-label">KPP Asal</label>
            <div class="col-sm-8">
                <input type="text" name="kpp_asal" class="autocomplete form-control input-sm">
            </div>
        </div>
        <div class="form-group">
            <label for="kpp_tujuan" class="col-sm-3 control-label">KPP Tujuan</label>
            <div class="col-sm-8">
                <input type="text" name="kpp_tujuan" class="autocomplete form-control input-sm">
            </div>
        </div>
        <div class="form-group">
            <label for="id_alket" class="col-sm-3 control-label">ID Alket</label>
            <div class="col-sm-8">
                <input type="text" name="id_alket" class="form-control input-sm" placeholder="ID Alket">
            </div>
        </div>
        <div class="form-group">
            <label for="npwp" class="col-sm-3 control-label">NPWP</label>
            <div class="col-sm-8">
                <input type="text" name="npwp_lengkap"  id="npwp" class="form-control input-sm" placeholder="NPWP">
            </div>
        </div>
        <div class="form-group">
            <label for="nama" class="col-sm-3 control-label">Nama</label>
            <div class="col-sm-8">
                <input type="text" name="nama"class="form-control input-sm" placeholder="Nama Wajib Pajak">
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-sm-6 col-lg-6">   
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="tgl_data"class="form-control datepicker input-sm" placeholder="Tgl Data">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="nilai_alket" class="numeric form-control input-sm" placeholder="Nilai">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" name="sumber_data" class="form-control input-sm" placeholder="Sumber Data">
            </div>
        </div>
    </div>
