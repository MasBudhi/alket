...
--
-- Table structure for table `dati2`
--

CREATE TABLE IF NOT EXISTS `dati2` (
  `id_kabupaten` int(10) NOT NULL auto_increment,
  `nama_kabupaten` varchar(100) NOT NULL,
  `id_propinsi` int(10) NOT NULL,
  PRIMARY KEY  (`id_kabupaten`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9273 ;

--
-- Dumping data for table `dati2`
--

INSERT INTO `dati2` (`id_kabupaten`, `nama_kabupaten`, `id_propinsi`) VALUES
